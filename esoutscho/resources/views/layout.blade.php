						...
						<!-- Panel (Banner) -->
							<section class="panel banner right">
								<div class="content color0 span-3-75">
									<h1 class="major">
مرحبا بكم<br />
									في منصتنا التعليمية</h1>
									<p font-size="100cm">This is <strong>Esoutscho</strong><br> منصة تعليمية / موقع للدورة التدريبية عبر الإنترنت تم تطويره من قبل طلاب شهادة التقني العالي </p>
									<ul class="actions">
										<li><a href="#first" class="button primary color1 circle icon solid fa-angle-right">Next</a></li>
									</ul>
								</div>
								<div class="image filtered span-1-75" data-position="70% 70%">
									<img src="images/Associationsdesoutiescolaire.png" alt="" />
								</div>
							</section>
